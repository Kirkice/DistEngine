...
bool EngineApp::Get4xMsaaState()const
{
	return m4xMsaaState;
}

void EngineApp::Set4xMsaaState(bool value)
{
...
void EngineApp::CreateCommandObjects()
{
	...
	ThrowIfFailed(md3dDevice->CreateCommandList(
		...
		mPSO.Get(),                   // Initial PipelineStateObject
	...
	memcpy(pVertexDataBegin, trianglesVertices, sizeof(trianglesVertices));
...
void EngineApp::FlushCommandQueue()
{
...
ID3D12Resource* EngineApp::CurrentBackBuffer()const
{
	return mSwapChainBuffer[mCurrBackBuffer].Get();
}

D3D12_CPU_DESCRIPTOR_HANDLE EngineApp::CurrentBackBufferView()const
{
...
D3D12_CPU_DESCRIPTOR_HANDLE EngineApp::DepthStencilView()const
{
...
void EngineApp::LogAdapterOutputs(IDXGIAdapter* adapter)
{
	UINT i = 0;
...
void EngineApp::LogOutputDisplayModes(IDXGIOutput* output, DXGI_FORMAT format)
{
	UINT count = 0;
	UINT flags = 0;
