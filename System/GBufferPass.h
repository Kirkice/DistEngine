...
public:
	...
	CD3DX12_GPU_DESCRIPTOR_HANDLE GBuffer0GPUSrv()const;
	CD3DX12_GPU_DESCRIPTOR_HANDLE GBuffer1GPUSrv()const;
	CD3DX12_GPU_DESCRIPTOR_HANDLE GBuffer2GPUSrv()const;
	CD3DX12_GPU_DESCRIPTOR_HANDLE GBuffer3GPUSrv()const;

	CD3DX12_CPU_DESCRIPTOR_HANDLE GBuffer0CPUSrv()const;
	CD3DX12_CPU_DESCRIPTOR_HANDLE GBuffer1CPUSrv()const;
	CD3DX12_CPU_DESCRIPTOR_HANDLE GBuffer2CPUSrv()const;
	CD3DX12_CPU_DESCRIPTOR_HANDLE GBuffer3CPUSrv()const;
