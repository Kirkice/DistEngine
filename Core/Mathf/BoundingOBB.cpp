...
namespace Dist
{
	...
	//BoundingOBB::BoundingOBB(Transform mTrans, Vector3 min, Vector3 max)
	//{
	//	trans = mTrans;
	//	m_min = mTrans.GetLocalToWorldMatrix() * min;
	//	m_max = mTrans.GetLocalToWorldMatrix() * max;
	//}

	//void BoundingOBB::AddPoint(Vector3 point)
	//{
	//	point = trans.GetLocalToWorldMatrix() * point;
