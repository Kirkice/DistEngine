...
EditorApp::EditorApp(HINSTANCE hInstance) : RenderApp(hInstance)
{
}
...
//	设置DockSpace
void EditorApp::SetDockSpace(bool* p_open)
{
	...
	//Draw Menu
	EditorApp::DrawMenuEditor();

	ImGui::End();
}

//	DrawMenuEditor
void EditorApp::DrawMenuEditor()
{
...
//	DrawHierachyEditor
void EditorApp::DrawHierachyEditor()
{
...
//	DrawInspectorEditor
void EditorApp::DrawInspectorEditor()
{
	const ImGuiViewport* main_viewport = ImGui::GetMainViewport();
...
//	DrawConsoleEditor
void EditorApp::DrawProjectEditor()
{
	const ImGuiViewport* main_viewport = ImGui::GetMainViewport();
...
//	DrawOverLayProfile
void EditorApp::DrawOverLayProfile()
{
	//static int corner = 0;
...
//	DrawPhysicsSettings
void EditorApp::DrawPhysicsSettings()
{
	//Render Item
...
void EditorApp::DrawProfileView()
{
	ImGui::Begin("Profile");
...
//	Light Settings
void EditorApp::DrawLightSettings()
{
	////Render Item
	//ImGui::SetWindowSize(ImVec2(180, 500));
...
//	PostProcessing
void EditorApp::DrawPostProcessingSettings()
{
	//Render Item
...
void EditorApp::SetDefaultStyle()
{
