/* $Header: /common/Render/src/SphericalHarmonics.cpp	8/21/21 18:26p Kirk 			    $ */
/*--------------------------------------------------------------------------------------------*
*                                                                                             *
*						Project Name : DistEngine                                             *
*                                                                                             *
*						File Name : SphericalHarmonics.cpp									  *
*                                                                                             *
*                       Programmer : Kirk                                                     *
*                                                                                             *
*---------------------------------------------------------------------------------------------*/
		...
		for (uint32 face = 0; face < 6; ++face)
		{
			for (uint32 y = 0; y < height; ++y)
			{
				for (uint32 x = 0; x < width; ++x)
				{
					...
					Vector3 sample = textureData.Texels[idx].To3D();
					...
					Vector3 dir = MapXYSToDirection(x, y, face, width, height);
