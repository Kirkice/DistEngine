/* $Header: /common/Render/include/GraphicsTypes.h	     8/28/21 13:13pm Kirk 			    $ */
/*--------------------------------------------------------------------------------------------*
*                                                                                             *
...
namespace render
{
	...
	{
		D3D12_CPU_DESCRIPTOR_HANDLE Handles[d3d12::RenderLatency] = { };
	...
	{
		ID3D12DescriptorHeap* Heaps[d3d12::RenderLatency] = { };
		...
		D3D12_CPU_DESCRIPTOR_HANDLE CPUStart[d3d12::RenderLatency] = { };
		D3D12_GPU_DESCRIPTOR_HANDLE GPUStart[d3d12::RenderLatency] = { };
