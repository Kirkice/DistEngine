...
#include "../../System/EngineSystem/DefaultFrameResource.h"
...
namespace Dist
{
    ...
    public:
        ...
        static const DXGI_FORMAT AmbientMapFormat = DXGI_FORMAT_R16G16B16A16_FLOAT;
    ...
    private:
        ...
        ///</summary>
        void BlurAmbientMap(ID3D12GraphicsCommandList* cmdList, DefaultFrameResource* currFrame, int blurCount);
