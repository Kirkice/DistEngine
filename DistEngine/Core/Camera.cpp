...
Vector3 Camera::GetPosition3f()const
{
...
void Camera::UpdateCamPosArray()
{
	mPosArray[0] = mPosition.x;
	mPosArray[1] = mPosition.y;
	mPosArray[2] = mPosition.z;
}

void Camera::UpdateCamRotArray()
{
